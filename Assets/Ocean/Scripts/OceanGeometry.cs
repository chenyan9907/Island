...
public class OceanGeometry : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        oceanMaterial.SetTexture("_Displacement_c0", waveGenerator.cascade0.RTDisplacement);
        oceanMaterial.SetTexture("_Derivatives_c0", waveGenerator.cascade0.RTDerivatives);
        oceanMaterial.SetTexture("_Turbulence_c0", waveGenerator.cascade0.RTTurbulence);

        oceanMaterial.SetTexture("_Displacement_c1", waveGenerator.cascade1.RTDisplacement);
        oceanMaterial.SetTexture("_Derivatives_c1", waveGenerator.cascade1.RTDerivatives);
        oceanMaterial.SetTexture("_Turbulence_c1", waveGenerator.cascade1.RTTurbulence);

        oceanMaterial.SetTexture("_Displacement_c2", waveGenerator.cascade2.RTDisplacement);
        oceanMaterial.SetTexture("_Derivatives_c2", waveGenerator.cascade2.RTDerivatives);
        oceanMaterial.SetTexture("_Turbulence_c2", waveGenerator.cascade2.RTTurbulence);
